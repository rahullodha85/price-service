...
object ApiRequestModel {
  ...
  def fromReq(request: RequestHeader): ApiRequestModel = {
    ...
    val help = if (request.secure) "https://" else "http://" + request.host + "/admin/api-docs/ui" //TODO: watch this
    ApiRequestModel(
      fullRequestUrl,
...
object ApiModel {
  ...
  implicit val optionReads: Reads[Option[JsValue]] = Reads.optionWithNull[JsValue]
